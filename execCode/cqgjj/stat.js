    ...
    k.prototype = {
            ...
            try {
                ...
                if ("[object Array]" === {}
                    ...
                    for (var b = 0; b < a.length; b++) {
                        ...
                        switch (c[0]) {
                            case "_setAccount":
                                e._cz_account = "[object String]" === {}
                                    .toString.call(c[1]) ? c[1] : String(c[1]);
                                break;
            ...
            try {
                ...
                if (a)
                    for (var d = a.split("&"), a = 0; a < d.length; a++)
                        c = l(d[a]), b = c.split("|"), this.a.b[l(b[0])] = {},
        ...
        k: function () {
            try {
                ...
                this.a.d ? b.push("p=" + f(this.a.d)) : "[object String]" === {}
                    .toString.call(this.D) && b.push("p=" + f(this.D));
                "[object String]" === {}
                    .toString.call(this.m) && b.push("ei=" + f(this.m));
                "[object String]" === {}
                    .toString.call(this.b) && b.push("cv=" + this.b);
                "[object String]" === {}
                ...
                var c = b.join("&");
                "[object String]" === {}
                    .toString.call(this.m) ? this.h(["http://ei.cnzz.com/stat.htm?" + c]) : this.s || this.l ? this.h(["http://ca.cnzz.com/stat.htm?" + c]) : (this.L && this.h(["http://" + this.L + "/stat.htm?" + c]), this.P && this.h(["http://" + this.P + "/stat.htm?" + c]))
            } catch (d) {
                g(d, "sD failed")
            }
        },
